...
//        String address = LoginRepository.getInstance(new LoginDataSource()).getUser().getAddress();
        ...
        Provider enel = new Provider("0001", "Enel", eUtilities, R.drawable.ic_enel_logo_large, R.drawable.ic_enel_logo_small, "080070809", "În România, Grupul Enel deserveşte 2,8 milioane de clienţi prin reţeaua sa de furnizare şi distribuţie, iar Enel Green Power deţine şi operează centrale de producţie a energiei din surse regenerabile.", "contacteem.ro@enel.com", enelContract);
